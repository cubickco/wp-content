		...
		<?php else : ?>
			...
			<div class="variations" cellspacing="0">
				...
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
						...
						<div id="variation_title" class="label"><label for="<?php echo esc_attr( sanitize_title( $attribute_name ) ); ?>"><?php echo wc_attribute_label( $attribute_name ); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></label></div>
						<div class="value">
							<?php
